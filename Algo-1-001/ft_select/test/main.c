...
int		main(int argc, char **argv)
{
	...
	else
	{
		...
		if (argc > 1)
		{
			...
			ft_putstr(argv[1]);// ON AFFICHE ARGV[1] QUI SERA SOUS MR 
...
/* right */		if ((read_char[0] == 27 && read_char[1] == 91 && read_char[2] == 67))
					tputs(tgetstr("nd", NULL), 1, tputs_putchar);
/* left	*/		if ((read_char[0] == 27 && read_char[1] == 91 && read_char[2] == 68))
					tputs(tgetstr("le", NULL), 1, tputs_putchar);
/* down */		if ((read_char[0] == 27 && read_char[1] == 91 && read_char[2] == 66))
				{
					tputs(tgetstr("do", NULL), 1, tputs_putchar);
				}
/* delete*/		if (((read_char[0] == 126 || read_char[0] == 127)  && read_char[1] == 0 && read_char[2] == 0))
				{
